...
5. **Graph:** Use `rms_graph` (neighbors/path/ensure) or search `include_graph_neighbors` to traverse durable Markdown/code links. Visual GraphView remains GUI-only.
<!-- RMS-MEMORY-END -->
