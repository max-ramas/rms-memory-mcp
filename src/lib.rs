...
#[doc(hidden)] pub mod commands;
#[doc(hidden)] pub mod import;
#[doc(hidden)] pub mod installer;
#[doc(hidden)] pub mod link;
#[doc(hidden)] pub mod mcp_server;
#[doc(hidden)] pub mod rules_injector;
